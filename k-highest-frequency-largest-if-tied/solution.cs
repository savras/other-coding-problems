...
namespace ConsoleApplication1
{
    class Solution
    {
        // Find the Kth most occurring number in an unsorted array.
        // If their frequency are tied, output the largest number among them
        public static void KthOccurrence(int[] arr, int k)
        {
            var dict = new Dictionary<int, int>();  // Value is the frequency of occurrence.
